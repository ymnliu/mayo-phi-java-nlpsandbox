...
public class TextPersonNameAnnotationsApiController implements TextPersonNameAnnotationsApi {

    private final NativeWebRequest request;

    @org.springframework.beans.factory.annotation.Autowired
    public TextPersonNameAnnotationsApiController(NativeWebRequest request) {
